...
本阶段聚焦 Claude Code 生态的核心基础知识，为后续深入学习打下坚实基础。通过本阶段学习，你将掌握**配置和使用 AI 能力**的核心方法，包括 Claude Code 的配置系统和 MCP 协议的基础应用。
...
### 快速模式（仅理论）
- claude-code-core：约 1-2 天
- mcp-basics：约 1 天
- **合计**：约 2-3 天

### 完整模式（理论+实践）
- claude-code-core：约 3-4 天
- mcp-basics：约 2-3 天
- **合计**：约 1-1.5 周
