...
> 本文件用于追踪整个 Claude Code 学习计划的整体进度。更新日期：2026-02-26
...
| 模块 | 优先级 | 学习模式 | 状态 | 完成度 |
|------|--------|----------|------|--------|
| claude-code-core | P0 🔴 | 完整模式 | 进行中 | 0% |
...
| 2026-02-26 | - | 完成 Study Skill | 创建 /study 工作流程 Skill（start/update/complete/status 命令） |
| 2026-02-26 | claude-code-core | 开始学习 | 选择完整模式 |
