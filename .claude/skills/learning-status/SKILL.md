...
description: AI 技术学习状态管理（常驻技能）- 查看学习状态、更新模块进度、目标状态查询、共享机制库。当用户说"查看学习状态"、"进度怎么样"、"我学哪了"、"更新进度"、"记录进度"、"打勾"、"查看<模块名>状态"、"<模块名>进度如何"、"目标状态"、"当前目标"时触发此技能。
---
...
**触发方式**（任意一种）：
- "查看 `<目标名>` 状态" / "`<目标名>` 目标状态" / "`<目标名>` 进度"

**执行步骤**：

1. 在 `.learning/goals/` 目录下查找目标文件
